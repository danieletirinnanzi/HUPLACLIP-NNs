...
#SBATCH --job-name=cnn_exp_N600
#SBATCH --mail-type=ALL
#SBATCH --mail-user=dtirinna@sissa.it
#SBATCH --output=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/N600/%x.%j.out
#SBATCH --error=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/N600/%x.%j.err
...
# - STANDARD CASE:
# torchrun --standalone --nproc_per_node=4 main.py --config docs/cnn_exp_config_N600.yml
# - RESUME CASE (for continuing a previous experiment):
torchrun --standalone --nproc_per_node=4 main.py --resume --exp_name cnn_exp_N600_2025-11-14_21-56-42
