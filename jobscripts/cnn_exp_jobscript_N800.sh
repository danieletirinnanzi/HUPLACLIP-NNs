...
#SBATCH --job-name=cnn_exp_N800
#SBATCH --mail-type=ALL
#SBATCH --mail-user=dtirinna@sissa.it
#SBATCH --output=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/N800/%x.%j.out
#SBATCH --error=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/N800/%x.%j.err
...
# - STANDARD CASE:
# torchrun --standalone --nproc_per_node=4 main.py --config docs/cnn_exp_config_N800.yml
# - RESUME CASE (for continuing a previous experiment):
torchrun --standalone --nproc_per_node=4 main.py --resume --exp_name cnn_exp_N800_2025-11-15_01-40-30
