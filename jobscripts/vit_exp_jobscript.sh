...
# - STANDARD CASE:
torchrun --standalone --nproc_per_node=4 main.py --config docs/vit_exp_config.yml
# - RESUME CASE (for continuing a previous experiment):
# torchrun --standalone --nproc_per_node=4 main.py --resume --exp_name vit_exp_YYYY-MM-DD_HH-MM-SS
