...
#SBATCH --output=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/cnn_exp/%x.%j.out
#SBATCH --error=/leonardo/home/userexternal/dtirinna/HUPLACLIP-NNs/out/cnn_exp/%x.%j.err
