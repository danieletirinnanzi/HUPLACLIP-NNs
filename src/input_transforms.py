...
# Function needed to resize images to 2400x2400 tensors (for ConvNets)
def cnn_transform(adjacency_matrix, output_size=(2400, 2400)):
    """
    Transform for creating inputs for Convolutional Neural Networks. The transformation is applied to the adjacency matrix of the graph:
