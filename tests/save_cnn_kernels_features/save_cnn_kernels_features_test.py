...
# custom imports
from src.utils import load_config, load_model, save_cnn_kernels_features
...
# # command to run
# torchrun --standalone --nproc_per_node=1 -m tests.save_cnn_kernels_features.save_cnn_kernels_features_test
...
print(f"Running 'save_cnn_kernels_features_test' on device id: {device_id}.")
